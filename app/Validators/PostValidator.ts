...
export default class PostValidator {
  ...
  */
  public messages = {
    ...
    'title.maxLength': 'O título deve ter no mínimo 3 caracteres',
    'title.minLength': 'O título deve ter no máximo 50 caracteres',
    'content.required': 'O conteúdo do post é necessário',
    'content.maxLength': 'O conteúdo deve ter no mínimo 5 caracteres',
    'content.minLength': 'O conteúdo deve ter no máximo 1000 caracteres',
  }
}
